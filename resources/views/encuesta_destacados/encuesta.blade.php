...
<div class="fondo_encuesta">
    ...
    <div class="blank_square" id="rlist">
                 ...
                 <hr>
                 <br>                 En el marco del 40 aniversario del Programa de Vinculación con los Egresados, Queremos reconocer a <b>cuatro egresadas o egresados que han dejado una huella</b>, no solo en su profesión, sino también en nuestra sociedad, representando los valores de nuestra Universidad con su trabajo y compromiso.
                <br>
                ...
                <br>
                Te invitamos a ser parte de este reconocimiento, participando en la nominación de dos egresados universitarios que consideres que cuentan con los méritos y logros que los hagan candidatos a este honor.
                <br>
                ...
                <form action="{{ route('enc_destacados.save')}}" method="POST" enctype="multipart/form-data">
                   @csrf    
                   <h1 class="black_text" style="color:#002b7a; font-size:2.6vh">Quiero nominar a:</h1>
             
                   <div class="form-group">
                    <label for="exampleFormControlInput1">Nombre</label> <br>
                    <input type="text" id="exampleFormControlInput1" style="border:3px solid #0f0f0f;font-size:2.8vh;width:70%">
                 ...
                 <h2 class="black_text" style='color:#002b7a; font-size:2.6vh'>Puesto que considero que su labor ha marcado una diferencia por los siguientes motivos:</h2>
                   ...
                   <div class="form-group">
                   <label for="exampleFormControlInput1">Razoner para la nominación</label> <br>
                    <textarea type="text" class="form-control" id="exampleFormControlInput1" style="border:3px solid #0f0f0f;font-size:2.1vh; width:70%" ></textarea>
                </div>
        <br><br>
        <hr>
            ...
            Para el programa de seguimiento de egresados es muy importante manenernos en comunicación con usted, por favor actualice sus datos de contacto, para que la universidad continue a la vanguardia de sus egresados, sus datos personales estan protegidos y puede consultar aquí el <a href="http://www.pveaju.unam.mx/avisodeprivacidad"><b>Aviso de Provacidad</b></a>
                ...
                <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="exampleFormControlInput1" @if($Egresado) value="{{$Egresado->fec_nac}}" @endif disabled style="background-color:#868b94">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Número de Cuenta</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" @if($Egresado) value="{{$Egresado->cuenta}}" @endif disabled style="background-color:#868b94">
                </div>
